    ...
    <div className="testimonials">
      <div className="card card--bg-purple">
        <header className="card__header">
          <img src={daniel} className="card__img" alt="" />
          <div>
      ...
      <div className="card card--bg-gray-blue">
        <header className="card__header">
          <img src={jonathan} className="card__img" alt="" />
          <div>
      ...
      <div className="card jannete">
        <header className="card__header">
          <img src={jeanette} className="card__img" alt="" />
          <div>
            <h3>Jeanette Harmon</h3>
            <p>Verified Graduate</p>
          </div>
        </header>
        <p className="card__lead">An overall wonderful and rewarding experience</p>
        <p className="card__quote">
      ...
      <div className="card card--bg-black-blue">
        <header className="card__header">
          <img src={patrick} className="card__img" alt="" />
          <div>
      ...
      <div className="card">
        <header className="card__header">
          <img src={kira} className="card__img" alt="" />
          <div>
            <h3>Kira Whittle</h3>
            <p>Verified Graduate</p>
          </div>
